...
data-toggle="dropdown" aria-expanded="false">
                  <img src="images/img.jpg" alt="">Mustafa Aydın
...
Önce</span>
          ...
          <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
            <div class="left"></div>
            <div class="right">
              <span class="count_top"><i class="fa fa-user"></i> Anlık 
Ziyaretçi</span>
              <div class="count"><b id="thisnow"></b></div>
              <span class="count_bottom"><i class="green"><i class="fa 
fa-sort-asc"></i>34% </i> En Son Oturum Açımı</span>
            </div>
          </div>
              ...
              <div class="col-md-4 col-sm-4 col-xs-8">
                    ...
                    <div class="row weather-days">
                      <div class="col-sm-2">
                        <div class="daily-weather">
                          <h2 class="day">Mon</h2>
                          <h3 id="wmonday" class="degrees"></h3>
                          <span>
                      ...
                      <div class="col-sm-2">
                        <div class="daily-weather">
                          <h2 class="day">Tue</h2>
                          <h3 id="wsunday" class="degrees"></h3>
				<canvas height='32' width='32' id='rain'> </canvas>
                      ...
                      <div class="col-sm-2">
                        <div class="daily-weather">
                          <h2 class="day">Wed</h2>
                          <h3 id="wtuesday" class="degrees"></h3>
                      ...
                      <div class="col-sm-2">
                        <div class="daily-weather">
                          <h2 class="day">Thu</h2>
                          <h3 id="wwednesday" class="degrees"></h3>
                      ...
                      <div class="col-sm-2">
                        <div class="daily-weather">
                          <h2 class="day">Fri</h2>
                          <h3 id="wthursday" class="degrees"></h3>
...
<script>
   ...
   <script>
        ...
        xmlhttp.open("GET", 
	"http://api.openweathermap.org/data/2.5/forecast?q=Adana&appid=541515afee797cfd215e0b69dfe8c5d9", true);
        xmlhttp.send(); // chart.
