                ...
                function updateConfigByMutating(chart) {
                    ...
                    $.getJSON("../../tcountSearch.php",myObject, function(jd) {
                        ...
                        for (i = 0; i < jd.length; i++) {
                            ...
                            var oranTotal = (((total - pretotal) / pretotal) * 100);
                                if (oranTotal > 0) {
...
//"2013", "2014", "2015", "2016"];
                    ...
                    function updategetMonthValue(chart) {
                        ...
                        //chart.destroy();
                        var myObject = {name: picker.startDate.locale('tr').format('YYYY-MM-DD'), s: "submit",
                        surname: picker.endDate.locale('tr').format('YYYY-MM-DD')};
