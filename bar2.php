	 ...
	 <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
		<div class="col-md-4">
                  <h2>Haftalık Karşılaştırmalı Grafik<small></small></h2>
			</div>
	  	<div class="col-md-8">
	...
	<div class="col-md-8 col-sm-8 col-xs-12">
	  ...
	  <div class="col-md-4 col-sm-4 col-xs-12">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Hızlı Aylık Trafik Tablosu  <small>B&G Store-Forum Mersin</small></h2>
...
+ end.locale('tr').format('MMMM D, YYYY'));
      ...
      var optionSet1 = {
        ...
        ranges: {
          'Bugün': [moment(), moment()],
          'Dün': [moment(), moment().subtract(1, 'days')],
...
picker.endDate.locale('tr').format('DD.MM.YYYY'));
	...
	//}
         ...
         $link = 
"/../../tcountSearch.php?"+"name"+"="+picker.startDate.locale('tr').format('DD.MM.YYYY')+"&"+"s=submit";
	...
	$link = "/../../tcountSearch.php?"+"name"+"="+picker.endDate.locale('tr').format('DD.MM.YYYY')+"&"+"s=submit";
	prexmlhttp.open("GET", $link, true);
	...
	//}
         ...
         $link = "/../../tcountSearch.php?"+"name"+"="+"18.02.2019"+"&"+"s=submit";
	...
	$link = "/../../tcountSearch.php?"+"name"+"="+"20.02.2019"+"&"+"s=submit";
	prexmlhttp.open("GET", $link, true);
        prexmlhttp.send(); // chart.
